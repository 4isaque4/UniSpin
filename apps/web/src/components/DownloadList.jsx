...
const DOWNLOAD_SECTIONS = {
  "sage-treinamento": {
    ...
    folderMeta: "Pasta completa • Varios arquivos",
  ...
  "curso-solar-fotovoltaico": {
    ...
    subtitle: "Exercicios e materiais complementares da trilha de energia solar.",
    folderTitle: "Exercicios do Curso",
    folderMeta: "Pasta completa • Varios arquivos",
    folderDescription: "Conteudo da trilha para consulta e acompanhamento das aulas.",
