...
export const TRILHAS = [
  ...
  },
  {
    ...
    cor: "#68217A", // Cor roxa do C#
    rota: "/videos",
    icone: "code",
    videos: [
      "sflHrKPxFGk", // Aula 01 - Apresentação do Editor Online Repl.it
      "ZbHxQwmgd5E", // Aula 02 - Revisão dos Fundamentos
      "Z_ma3sjD6h0", // Aula 03 - Atributos, Propriedades e Escopos de Visibilidade em C#
      "kCJTBQDIxq0", // Aula 04 - Métodos Construtores e Métodos Comuns
      "XS3SqZU7KFA", // Aula 05 - Estudo de Caso de Cadastro de Produtos
      "iZN38I2YvsI", // Aula 06 - Construtor Padrão e Parametrizado
      "H2UCo89SggM", // Aula 07 - Construtor Estático e Destrutor
      "jfhGyfZcpYg", // Aula 08 - Métodos Sobrecarregados
      "8NtOIta9-Os", // Aula 09 - Estudo de Caso da Classe Pessoa
      "llOu7J4AM_c", // Aula 10 - Herança de Classes
      "jwwzEfOz7wI", // Aula 11 - Classes Abstratas e Membros Abstratos
      "NNWJ81QAKIk", // Aula 12 - Implementando Polimorfismo
      "V2XBmQwWsuw", // Aula 13 - Recapitulando e Integrando os 4 Pilares da POO
      "MelZf6g7nto", // Aula 14 - Criando um Jogo :: Parte 1
      "C7gzm3CklmQ", // Aula 15 - Criando um Jogo :: Parte 2
      "WhttTs6743Q", // Aula 16 - Criando um Jogo :: Parte 3
      "A3NShCZ8cnc", // Aula 17 - Criando um Jogo :: Parte 4
      "dHszMx1Iozw", // Aula 18 - Criando um Jogo :: Parte 5
      "jtMuHY-2Ptw", // Aula 19 - Criando um Jogo :: Parte 6
      "rQNDlAMQss4", // Aula 20 - Interfaces de Classe
      "NVC-YB29hto", // Aula 21 - Tratamento de Exceções
      "0xxbsSIYDE8", // Aula 22 - Eventos e Delegates
      "Uuqnus2JHfU", // Aula 23 - Programação Assíncrona com Threads e Tasks
      "R2SBDrxoSRI"  // Aula 24 - Debugando Programas no Visual Studio 2019
    ]
  },
  {
    id: "curso-sql-completo",
    titulo: "Curso SQL Completo",
    descricao: "Manual básico para material inicial de estágio na Spin. Curso completo de SQL para iniciantes com desafios e muita prática. Conteúdo necessário para o estágio inicial na empresa.",
    duracaoTotal: "3:50:07",
    quantidadeVideos: 1,
    nivel: "Iniciante",
    categoria: "Banco de Dados",
    cor: "#0078D4", // Cor azul do SQL Server
    rota: "/videos",
    icone: "database",
    videos: [
      "G7bMwefn8RQ"  // Curso SQL Completo 2025 [Iniciantes] + Desafios + Muita Prática
    ]
  }
];
